...
if __name__ == "__main__":
    ...
    parser.add_argument("folder_path", type=str, help="origin_data_path")
    args = parser.parse_args()
    left_folder = args.folder_path + "images_left"  # 左目图像文件夹路径
    right_folder = args.folder_path + "images_right"  # 右目图像文件夹路径
    output_folder_l = args.folder_path + "image0"  # 输出文件夹路径
    output_folder_r = args.folder_path + "image1"
